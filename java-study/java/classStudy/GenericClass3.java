...
public class GenericClass3 {
	...
	public void processList(arrayStudyList<? extends Number> list) {
	...
	// 타입 파라미터
	public <T extends Number> void addToNumberList(arrayStudyList<T> list, T item) {
		list.add(item);
	}
	
	// ? super T
	public void processList2 (arrayStudyList<? super Integer> list) {
		list.add(1);
		list.add(2);
		list.add(3);
		list.add(4);
	...
	public static void main(String[] args) {
		...
		arrayStudyList<Integer> integerList = new arrayStudyList<>();
		integerList.add(1);
		integerList.add(2);
		integerList.add(3);
		
		arrayStudyList<Double> doubleList = new arrayStudyList<>();
		doubleList.add(1.1);
		doubleList.add(1.3);
		doubleList.add(3.3);
		...
		arrayStudyList<Number> numbers = new arrayStudyList<>();
