...
public class ExceptionIO {
	...
	public void exception1 () {
		int [] intarrayStudy = {1,2,3,4};

		try {
			
			for (int i = 0; i < 5; i++) {
				System.out.println(intarrayStudy[i]);
			}
			
		} catch (arrayStudyIndexOutOfBoundsException e ){
	...
	public void exceoption2 () {
		...
		try {
			...
			System.out.printf("입력값 :: %s", arrayStudys.toString(list)).println();
